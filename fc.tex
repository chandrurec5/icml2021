...
The points gates (i.e., NPFs) are important and that the gates (i.e., NPFs) are learnt were also made in prior work \cite{npk}. In this paper we strengthen these with additional experiments (see \Cref{sec:exp}).
